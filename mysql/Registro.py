...
class RegistroU(object):
    def setupUi(self, Registro):
        ...
        Registro.setStyleSheet("*{font-family:Bahnschrift Condensed;\n"
"font-size:22px;\n"
"}\n"
"\n"
"#centralwidget{\n"
...
"")
    ...
    def retranslateUi(self, Registro):
        ...
        self.pushButton.setText(_translate("Registro", "Ingresar"))
                ...
                if (valor == False):
                    ...
                    if (clavecorr):
                        ...
                        if (clave == clave2):
                            ...
                            conexion = mysql.connector.connect(**dato)
                            cursor = conexion.cursor()
                            valores = "INSERT INTO usuario(`nombre`, `correo`, `usuarios`, `clave`) VALUES(%s,%s,%s,%s)"
                            cursor.execute(valores, (
                                nombre.lower(), usuario.lower(), correo.lower(), claveen.lower()))
                            conexion.commit()
                            try:
...
if __name__ == "__main__":
    ...
    Registro.setWindowIcon(QtGui.QIcon('Imagenes/granja.ico'))
    ui = RegistroU()
    ui.setupUi(Registro)
    Registro.show()
    sys.exit(app.exec_())
